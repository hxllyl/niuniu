...
class User < ActiveRecord::Base
  ...
  has_many :user_messages, class_name: 'UserMessage', dependent: :nullify # 这个是系统消息与用户的关联表 个人系统消息删除只能删除这个关系
  ...
  def could_update_my_resources?
    log_posts.update_resources.last.nil? || log_posts.update_resources.last.updated_at < 1.hour.ago
  end
